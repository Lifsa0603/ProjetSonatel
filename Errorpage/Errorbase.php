...
<body>
    <div class="main">
      <h1>
        <div style="background-color: orange;justify-items:center;align-items:center;text-align:center" >
            Ticket Pas réferencer dans la Base 
            <br>
            Donc ne peut être dans la <a href="../Barrenav/Historique.php">Rubrique Historique</a>
        </div>
      </h1>
  <div>
  ...
  <g id="train">
    <path fill="#ff8000" d="M344.5 248.5h507.2v37.8H344.5z"/>
    <g id="wheels">
    ...
    <g id="car-layers">
      ...
      <g id="Text">
        ...
        <text transform="translate(400 255)" class="st8 st10" font-size="24.025">
        Revenir a la page D'<a href="../Barrenav/Accueil.php" style="color:#ff8000" >Accueil</a>
        </text>
      </g>
      <g id="ladders">
        <g id="ladder-f">
